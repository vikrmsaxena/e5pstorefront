    ...
    >
      ...
      {IS_INFINITE_SCROLL ? (
        <InfiniteScroll
          ...
          component={
            <div
              className={`-mx-px border-gray-100 gap-x-8 gap-y-4 grid grid-cols-2 sm:mx-0 md:grid-cols-5 ${products.results.length < 6
                ? `lg:grid-cols-5`
                : 'lg:grid-cols-5'
                }`}
            >
        ...
        products && products?.results ? (
          <>
            ...
            {products.pages > 1 && !isLastPage && (
              <div className="w-48 sm:mt-8 mt-6 flex sm:flex-col1">
                <Button
