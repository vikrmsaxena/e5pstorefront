                    ...
                    >
                      ...
                      <form>
                        <Link href={`/${productData.slug}`}>
                          <button
                            type="submit"
                            className="mt-6 w-full bg-black border border-transparent rounded-sm py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
                          >
                            {BTN_SEE_MORE_DETAILS}
                          </button>
                        </Link>
