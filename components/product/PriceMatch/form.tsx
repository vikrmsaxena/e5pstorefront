        ...
        <Form>
          ...
          <div className="mt-5 flex justify-center items-center">
            <button
              ...
              className="w-full max-w-xs flex-1 bg-black border border-transparent rounded-sm py-3 px-8 flex items-center justify-center font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-gray-500 sm:w-full"
            >
              {BTN_SUBMIT}
            </button>
          </div>
