      ...
      {asyncMessage ? (
        ...
        <>
          <input
            ...
            value={commentTitle}
            className="sm:w-1/3 w-full mb-2 mt-2 mb-5 appearance-none min-w-0 bg-white border border-gray-300 rounded-sm shadow-sm py-2 px-4 text-gray-900 placeholder-gray-500 focus:outline-none focus:border-gray-500 focus:ring-1 focus:ring-gray-500 "
          />
          <textarea
            className="text-gray-900 bg-gray-50 border border-gray-400 leading-normal w-full h-20 py-2 px-3 font-medium placeholder-gray-700 focus:outline-none focus:bg-white"
          ...
          <button
            ...
            className="max-w-xs float-right flex-1 bg-black uppercase border border-transparent rounded-sm py-2 px-4 flex items-center justify-center font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-gray-500 sm:w-full"
          >
            {BTN_SUBMIT}
          </button>
        </>
