      ...
      {asyncMessage ? (
        ...
        <>
          <input
            ...
            value={commentTitle}
            className="sm:w-1/3 w-full mb-2 mt-2 mb-5 appearance-none min-w-0 bg-white border border-gray-300 rounded-sm shadow-sm py-2 px-4 text-gray-900 placeholder-gray-500 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-gray-500 "
          />
          <textarea
