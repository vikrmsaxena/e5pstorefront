    ...
    <Listbox value={selected} onChange={handleOnChange} disabled={isDisabled}>
      ...
      <div className="mt-1 relative">
        <Listbox.Button
          ...
          className={`${
            isDisabled ? 'opacity-40' : ''
          } relative w-full bg-white border border-gray-300 rounded-sm shadow-sm pl-3 pr-10 py-2 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-gray-500 focus:border-indigo-500 sm:text-sm`}
        >
