...
export const SIGN_UP_FOR_NEWSLETTER = 'Sign up to our newsletter'
export const SIGN_UP_TEXT =
  'Stay updated about the latest fashion & happenings You can unsubscribe at anytime. View our privacy & cookie policy.'
...
export const GENERAL_LOAD_MORE = 'Load More'