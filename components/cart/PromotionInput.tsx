...
export default function PromotionInput() {
  ...
  return (
    <div className="flex items-center">
      <div>
        <label className="text-black font-semibold text-md">{APPLY_PROMOTION}</label>
        <div className="flex flex-col">
          <div className="flex justify-start flex-col my-1">
          ...
          <div className="flex justify-center items-center">
            <input
              ...
              value={value}
              className="appearance-none min-w-0 w-full bg-white border border-gray-300 rounded-sm shadow-sm py-3 px-4 text-gray-900 placeholder-gray-300 focus:outline-none focus:border-gray-500 focus:ring-1 focus:ring-gray-500 "
            />
